...
test('public response uses an allowlist and drops employee information', () => {
  ...
  assert.deepEqual(Object.keys(r.stores.norrebro).sort(), ['actualHours', 'calendarFallbackDays', 'complete', 'components', 'cost', 'cutoff', 'estimated', 'scheduledFallbackHours', 'scheduledFallbackShifts', 'source', 'warnings']);
});
